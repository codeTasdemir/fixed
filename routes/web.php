...
Route::middleware('auth.check')->group(function (){
        ...
        //manager Routes
        Route::get('/manager-dashboard',function (){return view('manager_dashboard');})->name('manager_dashboard');
        Route::get('/department_employee',[managerController::class,'manager_control_panel'])->name('department_employee');
        Route::get('/manager_account',[managerController::class,'account'])->name('manager_account');
        ...
        //employee Routes
        Route::get('/employee-dashboard',function (){return view('employee_dashboard');})->name('employee_dashboard');
        Route::get('/my_salaries',[employeeController::class,'salaries_page'])->name('employee_salaries');
        Route::get('/employee_account',[employeeController::class,'account'])->name('employee_account');
